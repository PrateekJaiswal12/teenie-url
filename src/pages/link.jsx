    ...
    <>
      ...
      <div className='flex flex-col gap-8 sm:flex-row justify-between'>
        <div className='flex flex-col items-start gap-8 rounded-lg sm:w-2/5'>
          ...
          <a href={`${url?.original_url}`} target='_blank' className='text-3xl sm:text-4xl text-blue-400 font-bold hover:underline'>
          ...
          <Button 
            variant="ghost"
            onClick={() => 
              navigator.clipboard.writeText(`https://www.teenie.in/${url?.short_url}`)
            }
          >
              <Copy/>
          </Button >
        ...
        <Card className="sm:w-3/5">
          ...
          {stats && stats?.length ?(
            <CardContent className="flex flex-col gap-6" >
              ...
              <CardContent>
                {loadingStats === false ? "No Statistics yet" 
                : "Loading Statistics..."}
              </CardContent>
            )}
        </Card>
